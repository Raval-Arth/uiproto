    ...
    <div class="shadow-md h-min overflow-hidden bg-white rounded-lg shadow-${color}-200">
      <div class="px-5 py-3">
        <div class="flex items-center justify-between">
          <span class="py-1 text-lg">Occupation: </span>
          <select class='bg-${color}-50 p-1 outline-none ring ring-${color}-300 rounded-md' name="" id="">
            <option value="${
              ranking_copy[Math.floor(Math.random() * ranking_copy.length)]
            }">${
      ranking_copy[Math.floor(Math.random() * ranking_copy.length)]
    }</option>
            <option value="${
